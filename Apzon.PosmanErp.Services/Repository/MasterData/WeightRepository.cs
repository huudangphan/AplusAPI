...
{
    public class WeightRepository:BaseMasterData, IWeight
    {
        public WeightRepository(IDatabaseClient databaseService, string tableName) : base(databaseService, tableName)
        {
        }
        ...
        {
            return new HttpResult((MessageCode) ExecuteScalar("aplus_basemasterdata_validate_weight_constraints",
