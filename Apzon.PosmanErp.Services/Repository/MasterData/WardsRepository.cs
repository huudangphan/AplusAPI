...
{
    public class WardsRepository:BaseMasterData, IWards
    {
        public WardsRepository(IDatabaseClient databaseService, string tableName) : base(databaseService, tableName)
        {
        }
