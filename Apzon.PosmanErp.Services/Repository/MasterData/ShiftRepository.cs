...
{
    public class ShiftRepository : BaseMasterData, IShift
    {
        public ShiftRepository(IDatabaseClient databaseService, string tableName) : base(databaseService, tableName)
        {
        }
