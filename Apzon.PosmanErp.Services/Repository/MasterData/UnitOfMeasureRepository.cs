...
{
    public class UnitOfMeasureRepository : BaseMasterData, IUnitOfMeasure
    {
        public UnitOfMeasureRepository(IDatabaseClient databaseService, string tableName) : base(databaseService,
            tableName)
        {
        }
        ...
        {
            return new HttpResult((MessageCode) ExecuteScalar("aplus_basemasterdata_validate_uoms_constraints",
