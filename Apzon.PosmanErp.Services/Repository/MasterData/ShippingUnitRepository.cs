...
{
    public class ShippingUnitRepository:BaseMasterData, IShippingUnit
    {
        public ShippingUnitRepository(IDatabaseClient databaseService, string tableName) : base(databaseService, tableName)
        {
        }
