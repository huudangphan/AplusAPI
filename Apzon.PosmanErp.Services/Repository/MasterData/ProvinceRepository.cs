...
{
    public class ProvinceRepository:BaseMasterData, IProvince
    {
        public ProvinceRepository(IDatabaseClient databaseService, string tableName) : base(databaseService, tableName)
        {
        }
