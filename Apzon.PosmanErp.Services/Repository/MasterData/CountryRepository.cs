...
{
    public class CountryRepository:BaseMasterData, ICountry
    {
        public CountryRepository(IDatabaseClient databaseService, string tableName) : base(databaseService, tableName)
        {
        }
